...
/***************************************************************************
  Example for BME280 Weather Station using two Sensors with SPI
...
void setup() {
  ...
  //*********************************************************************  
  //Choose the communication protocol for both sensors
  ...
  //bme2.parameter.communication = 0;                    //I2C communication for Sensor 2 (bme2)
    ...
    bme1.parameter.communication = 1;                    //Software SPI for Sensor 1 (bme1)
    bme2.parameter.communication = 1;                    //Software SPI for Sensor 2 (bme2)

  //bme1.parameter.communication = 2;                    //Hardware SPI for Sensor 1 (bme1)
  //bme2.parameter.communication = 2;                    //Hardware SPI for Sensor 2 (bme2)
  
  //*********************************************************************  
  //Set the I2C address of your breakout board
  //Or ignore this if using the SPI Communication   
